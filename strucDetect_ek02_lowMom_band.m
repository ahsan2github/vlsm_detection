...
%parentDir = '/glade/scratch/khanm/Ekman_Ugeo2_2048x2048x64_Lz750';
%parentDir = '/scratch/ibrix/chpc_gen/u0699351/Ekman_Ugeo2_2048x2048x64_Lz750';
...
for frameNo = frameVec 
    stresFieldName = sprintf('ek02_shearStress%4.4i.bin',frameNo);
...
save('ek02_areaFrac_stressFrac_hxx_xx_band.mat','areaFracVec_low','fluxFracVec_low','noRect_low',...
